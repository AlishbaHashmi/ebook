          ...
          <div class="col-lg-12">
            <div class="banner_content text-center">
              <p class="text-uppercase">
                Best online books website
              </p>
              <h2 class="text-uppercase mt-4 mb-5">
                One Step Ahead This Season
              </h2>
              <div>
                <a href="#" class="primary-btn2 mb-3 mb-sm-0">Register Now</a>
                <a href="#" class="primary-btn ml-sm-3 ml-0">Log in</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="single_feature">
            <div class="icon"><span  class="bi bi-filetype-pdf"></span></div>
            <div class="desc">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-5">
          <div class="main_title">
            ...
            lets test your IQ level from participating in our competition.
            </p>
          </div>
        </div>
      </div>
